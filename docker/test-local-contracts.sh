...
php "${ROOT_DIR}/docker/test-yootheme-processor.php"
php "${ROOT_DIR}/docker/test-translation-editorial.php"
php "${ROOT_DIR}/docker/test-joomla-translation.php"
php "${ROOT_DIR}/docker/test-translation-links.php"
php "${ROOT_DIR}/docker/test-wpml-permalink.php"
php "${ROOT_DIR}/docker/test-translation-renderer-context.php"
