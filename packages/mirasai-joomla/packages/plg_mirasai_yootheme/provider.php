...
require_once $pluginSrc . '/Tool/TemplateStyleReadTool.php';
require_once $pluginSrc . '/Tool/TemplateStyleSourcesTool.php';
require_once $pluginSrc . '/Tool/TemplateStyleUpdateTool.php';
