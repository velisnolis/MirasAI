...
class TemplateElementAddTool extends AbstractTemplateElementWriteTool
{
    ...
    {
        return 'Adds a child element to a YOOtheme Builder layout target. Place it under a parent with parent_path, or between existing siblings with before_path/after_path. Supports templates, article layouts, and Builder modules. Requires if_match and uses dry_run/confirm_guarded_write before writing.';
    }
    ...
    public function getInputSchema(): array
    {
        return [
            ...
            'properties' => array_merge($this->targetSelectorSchema(), [
                'parent_path' => ['type' => 'string', 'description' => 'Parent element path as returned by template/element-list. Use root to add a top-level child. Mutually exclusive with before_path and after_path.'],
