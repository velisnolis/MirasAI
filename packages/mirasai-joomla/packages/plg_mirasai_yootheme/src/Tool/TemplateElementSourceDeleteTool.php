...
class TemplateElementSourceDeleteTool extends AbstractTemplateElementWriteTool
{
    ...
    {
        return 'Deletes YOOtheme Dynamic Source bindings from one template element. Defaults to removing source plus compatibility carriers props.source and source_extended. Requires if_match and uses dry_run/confirm_guarded_write before writing.';
    }
