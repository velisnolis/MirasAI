...
class TemplateElementReadTool extends AbstractTool
{
    ...
    public function handle(array $arguments): array
    {
        ...
        if ($articleId > 0) {
            return $this->handleArticle($articleId, $path, $includeChildren);
        }

        if ($moduleId > 0) {
            return $this->handleModule($moduleId, $path, $includeChildren);
        }
     ...
     */
    private function handleArticle(int $articleId, string $path, bool $includeChildren): array
    {
     ...
     * @return array<string, mixed>
     */
    private function handleModule(int $moduleId, string $path, bool $includeChildren): array
    {
