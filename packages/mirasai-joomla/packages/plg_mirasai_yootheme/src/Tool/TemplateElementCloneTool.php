...
class TemplateElementCloneTool extends AbstractTemplateElementWriteTool
{
    ...
    {
        return 'Clones one YOOtheme Builder layout element as the next sibling. Supports templates, article layouts, and Builder modules. Requires if_match and uses dry_run/confirm_guarded_write before writing.';
    }
