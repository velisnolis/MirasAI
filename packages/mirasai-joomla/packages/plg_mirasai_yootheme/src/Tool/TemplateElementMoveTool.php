...
class TemplateElementMoveTool extends AbstractTemplateElementWriteTool
{
    ...
    {
        return 'Moves one YOOtheme Builder layout element. Place it under a parent with target_parent_path, or between existing siblings with before_path/after_path. Supports templates, article layouts, and Builder modules. Requires if_match and uses dry_run/confirm_guarded_write before writing.';
    }
