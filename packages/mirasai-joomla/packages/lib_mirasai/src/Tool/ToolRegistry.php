...
class ToolRegistry
{
    ...
    private const CORE_TOOL_METADATA = [
        ...
        'content/translate' => ['description' => 'Creates or updates a translated version of an article. YOU must provide the translated content.', 'risk_level' => AbstractTool::RISK_GUARDED_WRITE],
        'content/translate-batch' => ['description' => 'Translates multiple articles to a target language in a single call.', 'risk_level' => AbstractTool::RISK_GUARDED_WRITE],
