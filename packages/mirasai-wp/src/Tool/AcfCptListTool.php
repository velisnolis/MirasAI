...
class AcfCptListTool extends AbstractTool
{
    ...
    {
        return 'Lists custom post types managed by ACF when the ACF post type manager is available.';
    }
    ...
    public function handle(array $arguments): array
    {
        ...
        $items = $this->items('acf-post-type');
