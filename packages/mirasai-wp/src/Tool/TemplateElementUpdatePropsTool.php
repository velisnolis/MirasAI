...
class TemplateElementUpdatePropsTool extends AbstractTemplateElementWriteTool
{
    ...
    {
        return 'Updates props on one YOOtheme Builder element. Supports templates, post/page layouts, and Builder widgets. Defaults to merge=true, so supplied props are merged into existing props.';
    }
    ...
    public function getInputSchema(): array
    {
        return [
            ...
            'properties' => array_merge($this->targetSelectorSchema(), [
                ...
                'props' => ['type' => 'object', 'description' => 'Props to merge into or replace on the target element.'],
                'merge' => ['type' => 'boolean', 'description' => 'If true or omitted, merge supplied props into existing props. If false, replace the props object.'],
